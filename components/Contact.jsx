        ...
        <div className='max-w-[1240px] m-auto px-5 py-16 w-full'>
            ...
            <div data-aos='fade-up' data-aos-offset='500' className='grid lg:grid-cols-5 gap-8'>
                ...
                <div className='lg:p-4 h-full'>
                    <div>
                    <img className='pb-3 rounded-xl ease-out duration-300' src='https://images.unsplash.com/photo-1517330486404-33542d376afd?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MjMxfHxsYXB0b3AlMjB3b3JraW5nfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=700&q=60'></img>
                    </div> 
                <div>
                    <h2 className='py-2 text-[#5651e5]'>Mark Teodoro</h2>
                    <p className='text-gray-200'>BS Computer Engineering | Front-End Web Developer</p>
                    <p className='py-4 text-gray-200'>I am looking for internship and freelance positions. Contact me and let's talk.</p>
                </div>
                <div>
