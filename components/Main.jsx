        ...
        <div id="home" className='w-full h-screen text-center bg-[#131628]'>
            <div data-aos='fade-left' data-aos-duration='700' className='max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center'>
                <div>
                    ...
                    <h1 className='py-4 text-gray-300'> Hi, I'm <span className='text-[#5651e5]'>Mark</span></h1>
                    <h1 className='py-2 text-slate-400'>A <span className='text-[#60c985]'>Front-End </span>Web Developer</h1>
                    <p className='py-4 text-slate-200 max-w-[70%] m-auto'>I'm a graduating <span className='font-semibold text-[#60c985]'>BS Computer Engineering</span> student at the 
                    <span className='font-semibold text-[#69c985]'> University of the Philippines Diliman,</span> and an aspiring front-end web developer. Currently, I'm focused on building responsive front-end web applications while learning back-end technologies</p>
                ...
                <div className='shadow-gray-400 flex justify-center items-center p-4 cursor-pointer hover:scale-110 ease-in duration-700 pt-5'>
                <p className='rounded-xl bg-[#5651e5] px-4 pt-2 pb-2 text-gray-900 hover:text-[#5651e5] hover:bg-gray-800 duration-500'>Download CV</p> 
                </div>
